...
--27
DECLARE @Type varchar(10) SET @type = 'Customer'
DECLARE @Type2 varchar(10) SET @Type2 = 'Supplier'
SELECT c.City, c.CompanyName Name, c.ContactName "Contact Name", @Type Type
FROM Customers c
UNION
SELECT City, CompanyName, ContactName, @Type2
FROM Suppliers